...
1. Save thought snapshots the submitted editor value. Enter snapshots the current thought and then starts a new line; Shift+Enter inserts a line break without saving.
